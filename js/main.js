  $(function () {
    $.getJSON( "./data15.json", function( data ) {
    var datas = [];
    ...
    $('.all_settle_spread15').text(averge_settle_spread);
  });

    $.getJSON( "./data14.json", function( data ) {
    var datas = [];
    var all_settle_spread = 0;
    var settle_count = 0;
    // console.log(data)
    ...
    console.log(all_settle_spread);
    console.log(settle_count);
    $('.all_settle_spread14').text(averge_settle_spread);
  });

        $.getJSON( "./data13.json", function( data ) {
    var datas = [];
    var all_settle_spread = 0;
    var settle_count = 0;
    // console.log(data)
    ...
    console.log(all_settle_spread);
    console.log(settle_count);
    $('.all_settle_spread13').text(averge_settle_spread);
  });

    $.getJSON( "./data12.json", function( data ) {
    var datas = [];
    var all_settle_spread = 0;
    var settle_count = 0;
    // console.log(data)
    ...
    console.log(all_settle_spread);
    console.log(settle_count);
    $('.all_settle_spread12').text(averge_settle_spread);
  });
});
